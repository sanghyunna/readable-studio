# Design system token layers (_schema reference)

**Parent:** [design-systems.md](design-systems.md) - authoring guide. This document is the structural token contract that `design-systems/_schema/` enforces.
