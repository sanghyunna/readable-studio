...
## Current Readable Studio scope

Readable Studio currently ships this entry as discovery metadata only. If this `SKILL.md`
...
If those upstream files are not installed, explain that Readable Studio only has the
catalog entry for this skill and ask whether to continue with Readable Studio's
