...
## Readable Studio orchestration mode

When this skill is invoked inside Readable Studio, treat it as the design-flow
...
3. Search across every available Readable Studio resource, not only this skill:
