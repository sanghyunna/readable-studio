...
import type { Project } from '@readable-studio/contracts';
...
You're picking up a Readable Studio project mid-flight in a fresh \`claude\` CLI session. Run \`claude\` at the working directory below; the design intent is captured in \`DESIGN.md\` at the project root.
