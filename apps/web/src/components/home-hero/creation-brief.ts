 ...
 * `metadata` wins over the default when the New Project modal or an import
 * already made an explicit choice. These human-readable labels are compatibility
 * fallbacks for direct consumers; the merge boundary
