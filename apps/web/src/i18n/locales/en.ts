...
export function getEn(): Dict {
  ...
  'questions.backToSummary': 'Back to questions',
  'questions.assumptions': 'Project assumptions',
  'questions.ledgerTrigger': 'Project assumptions: {count} active, {stated} confirmed by you',
  'questions.provenance.stated': 'Stated by you',
  'questions.provenance.inferred': 'Inferred',
  'questions.provenance.default': 'Working defaults',
  'questions.assumptionLabel': '{label}: {value} ({provenance})',
  'questions.influence': '{count} assumptions shaping every run · {stated} confirmed by you',
  'questions.correctTitle': 'Correct {label}',
  'questions.correctionDescription': 'This updates the project assumptions now. If work is running, the correction is queued for the next turn.',
  'questions.applyCorrection': 'Apply correction',
  'systemPrompts.designerCharter.label': 'Designer charter',
  'systemPrompts.designerCharter.description': 'Base identity, design workflow, content philosophy, and artifact handoff guidance.',
  'systemPrompts.discoveryWorkflow.label': 'Discovery and artifact workflow',
  'systemPrompts.discoveryWorkflow.description': 'First-turn discovery, artifact-specific roles, planning, brand handling, and quality rules.',
  'systemPrompts.deckFramework.label': 'Slide deck framework',
  'systemPrompts.deckFramework.description': 'Deck-specific authoring rules and the canonical navigation, scaling, and print scaffold.',
  ...
  'hosted.provider.eyebrow': 'Hosted Readable Studio',
  'hosted.provider.title': 'Connect a model provider',
  'hosted.provider.description': 'Your key stays in this hosted session and is never saved in the browser.',
  'hosted.provider.runtime': 'Agent runtime',
  'hosted.provider.provider': 'Provider',
  'hosted.provider.apiKey': 'API key',
  'hosted.provider.apiKeyPlaceholder': 'Paste a key for this session',
  'hosted.provider.save': 'Save key',
  'hosted.provider.test': 'Test connection',
  'hosted.provider.clear': 'Clear key',
  'hosted.provider.loading': 'Loading provider settings…',
  'hosted.provider.configured': 'Key configured for this session',
  'hosted.provider.notConfigured': 'No key configured',
  'hosted.provider.setSuccess': 'Key saved for this session.',
  'hosted.provider.testSuccess': 'Connection passed with {model}.',
  'hosted.provider.clearSuccess': 'Key cleared.',
  'hosted.provider.error': 'The provider request failed. Try again.',
  'hosted.content.eyebrow': 'Hosted workspace',
  'hosted.content.title': 'Project content',
  'hosted.content.description': 'Open an owned project by its opaque ID to manage isolated files.',
  'hosted.content.error': 'The hosted content request failed. Try again.',
  'hosted.content.downloadArchive': 'Download archive',
  'hosted.content.projectId': 'Project ID',
  'hosted.content.projectIdPlaceholder': 'project-id',
  'hosted.content.openProject': 'Open project',
  'hosted.content.browserLabel': 'Project files and folders',
  'hosted.content.files': 'Files',
  'hosted.content.newFile': 'New file',
  'hosted.content.noFiles': 'No files yet.',
  'hosted.content.fileSize': '{bytes} B',
  'hosted.content.folders': 'Folders',
  'hosted.content.noFolders': 'No folders yet.',
  'hosted.content.deleteNamed': 'Delete {path}',
  'hosted.content.delete': 'Delete',
  'hosted.content.newFolderPath': 'New folder path',
  'hosted.content.createFolder': 'Create folder',
  'hosted.content.uploadFiles': 'Upload files',
  'hosted.content.uploadDirectory': 'Upload directory (optional)',
  'hosted.content.upload': 'Upload',
  'hosted.content.filePath': 'File path',
  'hosted.content.filePathPlaceholder': 'index.html',
  'hosted.content.content': 'Content',
  'hosted.content.saveFile': 'Save file',
  'hosted.content.preview': 'Preview',
  'hosted.content.deleteFile': 'Delete file',
  'hosted.content.renameFile': 'Rename selected file',
  'hosted.content.rename': 'Rename',
  'hosted.content.confirmDelete': 'Delete {path}?',
  'hosted.content.previewTitle': 'Preview of {path}',
  ...
  'settings.onboardingCreateBody': 'Bring source text for a report, brief, presentation, or plan. AI generation creates the first draft and keeps it directly editable.',
  ...
  'settings.agentInstall.pathHint': 'If you installed a CLI with npm or Homebrew and it still shows as not installed, ensure the tool\'s bin directory is on the PATH the Readable Studio daemon inherits (Terminal vs GUI apps can differ on macOS). See QUICKSTART.md (section "Local agent CLI and PATH").',
  'settings.agentInstall.stepOpenLinks': 'Open Install or Docs for your preferred agent.',
  'settings.agentInstall.stepAuth': 'Authenticate with the vendor CLI (sign in or add API credentials) before returning to Readable Studio.',
  ...
  'settings.lowSpecMode': 'Low-spec mode',
  'settings.lowSpecModeHint': 'Reduces glass and decorative motion so slow or remote PCs stay responsive.',
  ...
  'settings.themeCatppuccinFrappe': 'Catppuccin Frappé',
  'settings.themeCatppuccinMacchiato': 'Catppuccin Macchiato',
  ...
  'settings.themeAccent': 'Use theme accent',
  ...
  'settings.mcpServerHint': 'Expose Readable Studio as an MCP server for your coding agent.',
  ...
  'settings.privacyHint': 'What data is shared with the Readable Studio team',
  'settings.privacyConsentKicker': 'Help us improve Readable Studio',
  'settings.privacyConsentLead': 'Readable Studio can share usage data with our team to help us improve. This includes:',
  ...
  'settings.codeAgentsTitle': 'Code agents',
  'settings.codeAgentsSubtitle': 'Choose which agents appear in agent selectors. Detection status is shown only for enabled agents.',
  'settings.codeAgentsReset': 'Reset to defaults',
  'settings.codeAgentsEmpty': 'No agents available from the catalog.',
  'settings.codeAgentCurrent': 'Current',
  'settings.codeAgentNotChecked': 'Not checked',
  'settings.codeAgentAvailable': 'Available',
  'settings.codeAgentUnavailable': 'Unavailable',
  ...
  'settings.mcpHint': 'Let coding agents (Cursor, Claude Code, VS Code…) read your Readable Studio projects directly.',
  'settings.mcpDaemonError': 'Couldn\'t reach the local daemon to resolve install paths ({error}). Make sure Readable Studio is running, then reopen this panel.',
  'settings.mcpBuildDaemon': 'Build the daemon first.',
  'settings.mcpNodeMissing': 'Node binary is missing.',
  'settings.mcpBuildHint': 'apps/daemon/dist/cli.js is missing. Run `pnpm --filter @readable-studio/daemon build` and refresh.',
  ...
  'settings.mcpCapabilityDefault': 'Default to the project and file you have open in Readable Studio, so you can refer to the current document without restating its location.',
  'settings.mcpRunningNote': 'Readable Studio must be running for MCP tool calls to succeed. If you started your coding agent first, restart it so it can reach the live daemon.',
  ...
  'entry.discordAria': 'Open the Readable Studio Discord',
  'entry.discordAriaWithOnline': 'Open the Readable Studio Discord - {online}',
  ...
  'hub.paletteSearch': 'Search projects, sessions, and destinations',
  'hub.paletteNoResults': 'No matching results',
  'hub.paletteMove': 'Move',
  'hub.paletteActivate': 'Open',
  'hub.paletteClose': 'Close',
  'hub.filterLabel': 'Filter list',
  'hub.filterAll': 'All',
  'hub.filterAttention': 'Needs you',
  'hub.filterRunning': 'Running',
  'hub.sortRecent': 'Recent',
  'hub.sortName': 'Name',
  'hub.sortLabel': 'Sort',
  'hub.stateRunning': 'Running',
  'hub.stateAwaiting': 'Awaiting input',
  'hub.stateFailed': 'Failed',
  'hub.stateDone': 'Done',
  'hub.showMoreSessions': 'Show {count} more sessions',
  'hub.newSession': 'New session',
  'hub.newSessionIn': 'New session in {name}',
  'hub.sessionCreated': 'Created a new session in {name}',
  'hub.sessionDeleted': 'Deleted the session {name}',
  'hub.sessionInfo': 'View info',
  'hub.peekSession': '{name} info',
  'hub.rowMenu': '{name} menu',
  'hub.closeOpenWork': 'Close {name}',
  'hub.closedOpenWork': 'Closed {name}',
  'hub.inspectorTitle': 'Session info',
  'hub.inspectorClose': 'Close info',
  'hub.inspectorState': 'State',
  'hub.inspectorMode': 'Mode',
  'hub.inspectorMessages': 'Messages',
  'hub.inspectorLastActivity': 'Last activity',
  'hub.inspectorOpen': 'Open session',
  'hub.modeDesign': 'Design',
  'hub.modeChat': 'Chat',
  'hub.emptyFiltered': 'No sessions match this filter.',
  'hub.clearFilter': 'Clear filter',
  'hub.sessionsUnavailable': 'Sessions unavailable.',
  'hub.sessionsStale': 'Showing the last known sessions; the latest read failed.',
  'hub.retrySessions': 'Retry',
  'hub.sessionsFailed': 'Sessions could not be loaded for {count} projects.',
  'hub.openWork': 'Open work',
  'hub.projects': 'Projects',
  'hub.results': 'Results',
  'hub.searchPlaceholder': 'Search projects and sessions',
  'hub.startTitle': 'What should we make?',
  'hub.composerPlaceholder': 'e.g. Turn the attached results into an executive quarterly report.',
  'hub.context': 'Context',
  'hub.send': 'Start',
  'hub.shortPromptError': 'Describe what you want to make in a little more detail.',
  'hub.liveRunning': 'Running',
  'hub.liveWorking': 'Working on {session} in {project}',
  'hub.dropToEditLabel': 'Drop a document here to edit it',
  'hub.dropToEditDetail': 'One HTML or Markdown file. Click to choose one instead.',
  'hub.dropToEditRelease': 'Release to start editing',
  'hub.dropToEditBusy': 'Opening the editing session…',
  'hub.dropUnsupported': '{name} is not an editable document. Drop an HTML or Markdown file.',
  'hub.dropOneAtATime': 'Drop one document at a time ({count} files dropped).',
  'hub.dropImportFailed': 'Couldn\'t open the document for editing.',
  'hub.noProjectsTitle': 'No projects yet',
  'hub.noProjectsBody': 'Describe a document above, or import a folder to start.',
  'hub.untitledSession': 'Untitled session',
  'hub.lowSpecMode': 'Low-spec mode',
  'hub.lowSpecModeHint': 'Reduce glass and decorative motion for slow or remote PCs.',
  ...
  'hub.theme': 'Theme',
  'hub.themeSubtitle': 'Applies right away and is kept for next time.',
  'hub.themeDone': 'Done',
  'entry.navHome': 'Home',
  ...
  'homeHero.title': 'What document do you want to create?',
  ...
  'homeHero.searchPrompt': 'Search files, plugins, skills, and MCP servers.',
  ...
  'homeHero.chip.createPluginHint': 'Author a reusable Readable Studio plugin and add it to My plugins.',
  ...
  'homeHero.chip.report': 'Report',
  'homeHero.chip.reportHint': 'Generate a flowing long-form report — title, exec summary, sections, tables, and appendix.',
  'projectFolderPicker.homeTitle': 'Choose where this project is saved',
  'projectFolderPicker.processing': 'Processing...',
  'projectFolderPicker.select': 'Project folder',
  'projectFolderPicker.clearAria': 'Clear project folder',
  ...
  'designSystemPicker.noPreview': 'No preview page. Readable Studio Systems to view the full preview.',
  ...
  'pluginsHome.subtitle': 'Ready-to-use Readable Studio workflows bundled with this runtime. Pick one to load a starter prompt, or browse the registry for more.',
  'pluginsHome.browseRegistry': 'Browse registry',
  'pluginsHome.count': '{filtered} of {total}',
  'pluginsHome.loadingCatalog': 'Loading catalog…',
  'pluginsHome.emptyCatalog': 'Catalog is empty. Bundled plugins ship with Readable Studio and should appear here automatically — try restarting the daemon if this persists.',
  ...
  'pluginsView.promptBody': 'Prompt body',
  ...
  'pluginCard.contributeAria': 'Contribute {title} to Readable Studio',
  'pluginCard.contributeTitle': 'Contribute plugin to Readable Studio with a pull request',
  'integrations.kicker': 'Integration',
  'integrations.lede': 'Connect external systems, bring MCP tools into your agent loop, and use Readable Studio from other IDEs, scripts, and automations.',
  ...
  'integrations.skillsBody': 'Skill-level integration management is being carried over from another branch. This tab is reserved so MCP and future Skills setup live in the same Integration route.',
  ...
  'mcpClient.daemonError': 'Could not reach the local daemon. Make sure Readable Studio is running, then reopen this panel.',
  ...
  'useEverywhere.section.overview.heading': 'Readable Studio works wherever your agent works',
  'useEverywhere.section.overview.intro': 'Readable Studio is more than a window — it is a local privileged daemon (`readable`) plus a Skills + Design-Systems + Atoms registry. Once it is running on your machine, any code agent (Claude Code, Codex, Cursor, OpenCode/openclaw, Hermes, your own script) can drive generations, inspect projects, and produce design artifacts through four interchangeable surfaces.',
  'useEverywhere.section.overview.bullet1': 'CLI — `readable <command>` for headless scripts, CI, and shell automation.',
  'useEverywhere.section.overview.bullet2': 'MCP server — wires Readable Studio as a Model Context Protocol server so any MCP-capable agent can list skills, run scenarios, and read artifacts.',
  ...
  'useEverywhere.section.overview.bullet4': 'Skills — drop-in `SKILL.md` packs (Claude-compatible) that any agent already on your PATH can invoke without Readable Studio at all.',
  ...
  'useEverywhere.section.overview.footer': 'The daemon writes to `./.readable-studio/` (project-local) by default. Set `READABLE_DATA_DIR=~/.readable-studio` to share data across projects.',
  'useEverywhere.section.cli.tab': 'CLI · readable',
  'useEverywhere.section.cli.heading': 'Drive Readable Studio from any shell',
  'useEverywhere.section.cli.intro': 'The `readable` bin ships with the daemon and is the same binary used by Claude Code / Codex when they run a generation. Most subcommands are thin clients that POST to the local daemon, so they work the same whether you launched it via `pnpm tools-dev` or as a packaged app.',
  'useEverywhere.section.cli.bullet1': '`readable` (no args) — boots the daemon and opens the web UI.',
  'useEverywhere.section.cli.bullet2': '`readable project create` + `readable run start` - create a project, send a message, and stream the run.',
  'useEverywhere.section.cli.bullet3': '`readable run ...` — start a project run from a prompt + skill.',
  'useEverywhere.section.cli.bullet4': '`readable plugin install <source>` / `readable plugin apply <id>` — install and apply community plugins.',
  'useEverywhere.section.cli.bullet5': '`readable skills list` / `readable design-systems list` — inspect what is available locally.',
  'useEverywhere.section.cli.bullet6': '`readable status` / `readable doctor` — verify daemon health and detect agent CLIs on your PATH.',
  'useEverywhere.section.cli.snippet1': 'Use the CLI from a source checkout',
  ...
  'useEverywhere.section.mcp.heading': 'Expose Readable Studio as an MCP server to any coding agent',
  'useEverywhere.section.mcp.intro': 'Readable Studio ships with a Model Context Protocol server (`readable mcp`) that lets any MCP-capable client — Cursor, Claude Code, Antigravity, VS Code Copilot Chat, openclaw, hermes — discover Readable Studio tools (list skills, render previews, generate media, run plugins) without shelling out manually. The daemon publishes a ready-to-paste install snippet via `GET /api/mcp/install-info` for each major client.',
  'useEverywhere.section.mcp.bullet1': 'Stdio transport — no extra port, the client spawns `readable mcp` directly.',
  ...
  'useEverywhere.section.mcp.bullet4': 'Pins `READABLE_DATA_DIR` so the spawned MCP process writes to the same place the daemon already uses (avoids EPERM in packaged macOS app bundles).',
  ...
  'useEverywhere.section.mcp.footer': 'In the Readable Studio app, open Settings → Integrations to copy a client-specific install command (Cursor, Claude Code, Antigravity, VS Code) instead of editing JSON by hand.',
  'useEverywhere.section.http.tab': 'HTTP API',
  'useEverywhere.section.http.heading': 'Same REST + SSE surface the web UI uses',
  'useEverywhere.section.http.intro': 'The local daemon serves an HTTP API at `http://127.0.0.1:7456` (port configurable). Every endpoint the web UI calls is also fair game for your scripts. Streaming endpoints (chat turns, project runs) emit Server-Sent Events with the contract types in `@readable-studio/contracts`.',
  ...
  'useEverywhere.section.skills.heading': 'Drop-in Skills for any agent — even without Readable Studio running',
  'useEverywhere.section.skills.intro': 'A Skill is a directory with a Claude-compatible `SKILL.md` (YAML front-matter + body). Readable Studio extends the format with the `readable:` namespace (`mode`, `preview`, `design_system`, `inputs`, …) so the same artifact can be used both inside Readable Studio and by a vanilla agent like Claude Code, Codex, openclaw, or hermes. Discovery follows a precedence chain so projects can override their own skills.',
  ...
  'useEverywhere.section.skills.bullet4': 'Headless: an agent with `readable` on its PATH can call `readable skills list` then run any skill; the daemon is optional for read-only flows.',
  ...
  'useEverywhere.section.skills.snippet1': 'Minimal SKILL.md (Claude-compatible front matter + Readable Studio extras)',
  ...
  'tasks.lede': 'Automations turn prompts into durable work: routines keep them around, schedules decide when they fire, and live artifacts show what changed.',
  'tasks.newAutomation': 'New automation',
  'tasks.previewNote': 'Preview surface only. Routines, schedules, and live artifact wiring will land as the backend branches merge.',
  ...
  'tasks.sample.weekly.body4': '- MCP quality sweep',
  ...
  'newproj.modeLabel': 'Session mode',
  'newproj.modeDesignHint': 'Create and change artifacts: pages, prototypes, decks.',
  'newproj.modeChatHint': 'Ask questions, plan, and review without producing an artifact.',
  ...
  'newproj.locationDefault': 'Readable Studio projects',
  ...
  'socialShare.projectTitle': '{title} · Readable Studio',
  'socialShare.projectText': 'Created with Readable Studio: {title}. View the document and star the repo: {repo}',
  'socialShare.projectCopyText': 'Created with Readable Studio: {title}\n{url}\nReadable Studio repo: {repo}',
  ...
  'inlineSwitcher.reasoningOff': 'Off',
  'inlineSwitcher.reasoningMinimal': 'Minimal',
  'inlineSwitcher.reasoningLow': 'Low',
  'inlineSwitcher.reasoningMedium': 'Medium',
  'inlineSwitcher.reasoningHigh': 'High',
  'inlineSwitcher.reasoningXHigh': 'Extra high',
  'inlineSwitcher.reasoningMax': 'Maximum',
  ...
  'databricks.addModels': 'Add Models',
  'databricks.modal.title': 'Add Databricks models',
  'databricks.modal.subtitle': 'Scan a workspace and register the endpoints you want to use. Registering a model never changes the active selection.',
  'databricks.modal.done': 'Done',
  'databricks.modal.checkingCli': 'Checking the Databricks CLI…',
  'databricks.modal.checkAgain': 'Check again',
  'databricks.modal.installCli': 'Install CLI',
  'databricks.modal.docs': 'Docs',
  'databricks.cli.missingTitle': 'Databricks CLI not found',
  'databricks.cli.missingBody': 'Model discovery runs through the Databricks CLI. Install it, then check again.',
  'databricks.cli.unsupportedTitle': 'Databricks CLI version not supported',
  'databricks.cli.unsupportedBody': 'The installed Databricks CLI is too old for model discovery. Update it, then check again.',
  ...
  'databricks.auth.keyringBody': 'The Databricks CLI cannot read stored credentials. Choose Sign in to log in through the CLI, then check again.',
  'databricks.auth.unreachableTitle': 'Workspace unreachable',
  'databricks.auth.unreachableBody': 'The Databricks workspace could not be reached. Check your network and sign-in, then check again.',
  'databricks.auth.unsupportedTitle': 'Sign-in method not supported',
  'databricks.auth.unsupportedBody': 'This CLI profile uses a sign-in method Readable Studio cannot use. Choose Sign in to log in through the CLI, then check again.',
  'databricks.profiles.label': 'CLI profile',
  'databricks.profiles.none': 'No CLI profiles found yet.',
  'databricks.profiles.default': 'Default',
  'databricks.profiles.authenticated': 'Signed in',
  'databricks.profiles.authRequired': 'Sign-in required',
  'databricks.profiles.unchecked': 'Not checked yet',
  'databricks.profiles.checking': 'Checking…',
  'databricks.setup.label': 'Connect a workspace',
  'databricks.setup.intro': 'Discovery and model calls go straight to your workspace’s serving APIs. Enter the workspace URL and a personal access token to get started; no CLI is needed.',
  'databricks.setup.hostLabel': 'Workspace URL',
  'databricks.setup.hostHint': 'The address you open in the browser to reach the workspace.',
  'databricks.setup.hostInvalid': 'Enter the full https:// workspace URL.',
  'databricks.setup.tokenLabel': 'Personal access token',
  'databricks.setup.tokenHint': 'Used only to authenticate this computer against the workspace. The local Readable Studio service keeps it; it is never shown here again.',
  'databricks.setup.submit': 'Connect and scan',
  ...
  'databricks.scan.rescan': 'Rescan',
  'databricks.scan.cancel': 'Cancel scan',
  'databricks.scan.running': 'Scanning…',
  'databricks.scan.complete': 'Scan complete',
  'databricks.scan.failed': 'Scan failed',
  'databricks.scan.cancelled': 'Scan cancelled',
  'databricks.scan.progress': '{scopes} scopes checked · {candidates} found',
  'databricks.scan.empty': 'No endpoints or model services were found in this workspace.',
  'databricks.scan.signInFirst': 'Sign in to a CLI profile to scan.',
  'databricks.scan.partialTitle': 'Partial scan',
  'databricks.scan.partialBody': '{inaccessible} of {checked} scopes could not be read, so some models may be missing. Rescan after fixing access.',
  'databricks.scan.truncatedBody': 'Enumeration was cut short, so some models may be missing. Rescan to see more.',
  'databricks.results.title': 'Discovered models',
  'databricks.results.registeredCount': '{n} registered',
  'databricks.results.register': 'Register',
  'databricks.results.registered': 'Registered',
  'databricks.results.pending': 'Saving…',
  'databricks.kind.serving': 'Serving endpoint',
  'databricks.kind.modelService': 'Model service',
  'databricks.api.openai': 'OpenAI API',
  'databricks.api.anthropic': 'Anthropic API',
  'databricks.api.unknown': 'Unknown API',
  'databricks.availability.compatible': 'Compatible',
  'databricks.availability.verificationRequired': 'Needs verification',
  'databricks.availability.unavailable': 'Unavailable',
  'databricks.availability.stale': 'Stale',
  'databricks.capability.tools': 'Tools',
  'databricks.capability.toolsUnavailable': 'Tools unavailable on tested routes',
  'databricks.capability.toolsUnknown': 'Tools unknown',
  'databricks.capability.artifactDelivery': 'This endpoint answers and delivers a complete document in chat, but cannot edit files directly on the tested routes.',
  'databricks.capability.images': 'Images',
  'databricks.issue.installCli': 'Install the Databricks CLI.',
  'databricks.issue.chooseExecutable': 'Choose a working Databricks CLI executable.',
  'databricks.issue.signIn': 'Sign in to the Databricks CLI.',
  'databricks.issue.rescan': 'Rescan the workspace.',
  'databricks.issue.verify': 'Verify this model before use.',
  'databricks.issue.checkPermissions': 'Check workspace permissions.',
  'databricks.error.generic': 'Something went wrong. Please try again.',
  'databricks.registeredNote': 'Registered models appear in the Databricks model dropdown. Registering never changes the active model.',
  ...
  'chat.activeFilePlaceholder': 'Ask Readable Studio to change {file}...',
  ...
  'chat.mode.design.summary': 'For creating or changing concrete outputs: pages, prototypes, slides, dashboards, and project files.',
  'chat.mode.design.solves': 'Use it to turn source text into a first draft, update workspace files, or refine a document for standalone HTML export.',
  'chat.mode.design.query1': 'Create a product launch landing page and interactive prototype from this brief.',
  'chat.mode.design.query2': 'Make a 10-slide investor deck with speaker notes.',
  'chat.mode.design.query3': 'Create campaign concepts and a project workspace for this brief.',
  ...
  'chat.designToolbox.searchPlaceholder': 'Search skills / MCP / plugins / design files...',
  ...
  'chat.designToolbox.action.auto-match.description': 'Define the taste bar first, then match skills, MCP, plugins, and files.',
  ...
  'chat.designToolbox.prompt.noSkill': 'If no specific skill matched, first choose the best combination from available skills, MCP, plugins, and design files.',
  ...
  'chat.designToolbox.prompt.autoMatchStep2': '2. Search and match the full resource index above. Do not only use design toolbox recommendations; combine skills, MCP, plugins, and design files when useful.',
  ...
  'chat.designToolbox.prompt.resourceIndex': 'Global resource index: skills({skills}), plugins({plugins}), MCP({mcpEnabled} enabled / {mcpTemplates} templates), design files({files}).',
  ...
  'chat.mentionSearchPrompt': 'Search Design Files, tabs, plugins, skills, and MCP servers.',
  ...
  'preview.shareTextDefault': 'Readable Studio template: {title}',
  ...
  'preview.errorBody': 'The example HTML failed to fetch. Make sure Readable Studio is running and try again.',
  'preview.retry': 'Retry',
  ...
  'designFiles.usefulInfoTip11': 'Select any element in the preview for direct editing without regenerating the whole document.',
  'designFiles.usefulInfoTip12': 'Not happy with a result? Circling it in the preview beats re-describing it.',
  'designFiles.usefulInfoTip13': 'Export the polished document as standalone HTML.',
  ...
  'fileViewer.commentOnElement': 'Comment on element',
  'fileViewer.previewToolsAria': 'Preview tools',
  'fileViewer.sendToLlm': 'Send to LLM',
  'fileViewer.directEdit': 'Direct edit',
  'fileViewer.edit': 'Edit',
  'fileViewer.draw': 'Draw',
  'fileViewer.mark': 'Select range',
  'fileViewer.markTool': 'Select range tool',
  ...
  'manualEdit.inspectorTitle': 'Edit',
  'manualEdit.editParams': 'Edit parameters',
  'manualEdit.closePanel': 'Close edit panel',
  'manualEdit.exitEditMode': 'Exit edit mode',
  'manualEdit.sectionText': 'Text',
  'manualEdit.sectionShape': 'Shape',
  'manualEdit.quickFormat': 'Quick format',
  'manualEdit.quickShape': 'Quick shape',
  'manualEdit.sizePosition': 'Size & position',
  'manualEdit.sectionTextDescription': 'Typography for the selected text element.',
  'manualEdit.sectionShapeDescription': 'Appearance and box model for the selected element.',
  'manualEdit.groupAppearance': 'Appearance',
  'manualEdit.groupSize': 'Size',
  'manualEdit.groupSpacing': 'Spacing',
  'manualEdit.groupBorder': 'Border',
  'manualEdit.groupLayout': 'Layout',
  ...
  'manualEdit.page': 'PAGE',
  'manualEdit.pageStyles': 'Page styles',
  'manualEdit.baseSize': 'Base size',
  'manualEdit.pageStylesUnavailable': 'Page styles are available only for full HTML documents.',
  'manualEdit.error.previewStyleFailed': 'Could not update the preview. Your saved edit was not changed.',
  'manualEdit.error.selectedTargetMissing': 'The selected element is no longer in the saved file. The preview was refreshed.',
  'manualEdit.error.stylesReconciled': 'Your edit was saved. The selected element was updated to match the saved file.',
  'manualEdit.error.duplicatePreviewFailed': 'Could not preview the duplicate. The original element was not changed.',
  'manualEdit.error.finishBeforeDuplicateFailed': 'Could not finish the current edit before duplicating. Try again.',
  'manualEdit.error.saveBeforeDuplicateFailed': 'Could not save the current edit before duplicating. Try again.',
  ...
  'manualEdit.error.applyFailed': 'Could not apply this edit. Check the value and try again.',
  'manualEdit.error.fileChangedBeforeUndo': 'The file changed outside Manual Edit. Refresh the preview before undoing.',
  'manualEdit.error.fileChangedBeforeRedo': 'The file changed outside Manual Edit. Refresh the preview before redoing.',
  'manualEdit.error.invalidStyleValue': 'Enter a valid style value.',
  ...
  'manualEdit.shape.paddingTop': 'Padding top',
  'manualEdit.shape.paddingRight': 'Padding right',
  'manualEdit.shape.paddingBottom': 'Padding bottom',
  'manualEdit.shape.paddingLeft': 'Padding left',
  'manualEdit.shape.spacing': 'Spacing',
  'manualEdit.spacing.selectedElement': 'Selected element',
  'manualEdit.spacing.selectPadding': 'Select padding',
  'manualEdit.spacing.selectMargin': 'Select margin',
  'manualEdit.spacing.linkAll': 'Link all sides',
  'manualEdit.spacing.resetAll': 'Reset to zero',
  'manualEdit.spacing.editing': 'Editing {kind}',
  'manualEdit.spacing.diagramHint': 'Select a colored area to switch between inside and outside spacing.',
  'manualEdit.geometry.sizing': 'Sizing',
  'manualEdit.geometry.position': 'Position',
  'manualEdit.geometry.modes': 'sizing modes',
  'manualEdit.geometry.auto': 'Auto',
  'manualEdit.geometry.fixed': 'Fixed',
  'manualEdit.geometry.fill': 'Fill',
  'manualEdit.geometry.keepAspect': 'Keep aspect ratio',
  'manualEdit.geometry.inFlow': 'With content',
  'manualEdit.geometry.directMove': 'Direct move',
  'manualEdit.geometry.flowTitle': 'Moves with surrounding content',
  'manualEdit.geometry.flowHelp': 'The element stays in its normal layout and moves naturally when nearby content changes.',
  'manualEdit.geometry.directTitle': 'Offset from the current position',
  'manualEdit.geometry.directHelp': 'Move the element by an exact X and Y distance without reflowing nearby content.',
  'manualEdit.geometry.offsetX': 'X offset',
  'manualEdit.geometry.offsetY': 'Y offset',
  'manualEdit.geometry.resetPosition': 'Reset position',
  'manualEdit.shape.margin': 'Margin',
  'manualEdit.shape.marginTop': 'Margin top',
  'manualEdit.shape.marginRight': 'Margin right',
  'manualEdit.shape.marginBottom': 'Margin bottom',
  'manualEdit.shape.marginLeft': 'Margin left',
  'manualEdit.shape.border': 'Border',
  'manualEdit.shape.borderWidths': 'Border widths',
  'manualEdit.shape.borderWidthsTop': 'Border widths top',
  'manualEdit.shape.borderWidthsRight': 'Border widths right',
  'manualEdit.shape.borderWidthsBottom': 'Border widths bottom',
  'manualEdit.shape.borderWidthsLeft': 'Border widths left',
  'manualEdit.shape.borderColor': 'Border color',
  'manualEdit.shape.style': 'Style',
  'manualEdit.shape.radius': 'Radius',
  'manualEdit.shape.opacity': 'Opacity',
  'manualEdit.shape.layout': 'Layout',
  'manualEdit.shape.gap': 'Gap',
  'manualEdit.shape.direction': 'Direction',
  'manualEdit.shape.justify': 'Justify',
  'manualEdit.shape.align': 'Align',
  'manualEdit.shape.more': 'More',
  'manualEdit.shape.fillHelp': 'Background color inside the element.',
  'manualEdit.shape.widthHelp': 'Horizontal size. CSS units are supported.',
  'manualEdit.shape.heightHelp': 'Vertical size. CSS units are supported.',
  'manualEdit.shape.paddingHelp': 'Space between the content and border.',
  'manualEdit.shape.marginHelp': 'Space outside the border.',
  'manualEdit.shape.borderWidthsHelp': 'Line thickness for each side.',
  'manualEdit.shape.borderColorHelp': 'Color of the element outline.',
  'manualEdit.shape.styleHelp': 'Line pattern used by the border.',
  'manualEdit.shape.radiusHelp': 'Rounds the element corners.',
  'manualEdit.shape.opacityHelp': '0% is transparent; 100% is opaque.',
  'manualEdit.shape.groupSurface': 'Fill & border',
  'manualEdit.shape.groupGeometry': 'Corners & opacity',
  'manualEdit.shape.borderWidthAll': 'Border width, all sides',
  'manualEdit.shape.borderWidthsPerSide': 'Edit each side',
  'manualEdit.shape.borderStyleDefault': 'Default border style',
  'manualEdit.shape.borderStyleSolid': 'Solid border',
  'manualEdit.shape.borderStyleDashed': 'Dashed border',
  'manualEdit.shape.borderStyleDotted': 'Dotted border',
  'manualEdit.shape.borderStyleDouble': 'Double border',
  'manualEdit.shape.borderStyleNone': 'No border',
  'manualEdit.shape.dangerZone': 'Element',
  'manualEdit.shape.gapHelp': 'Space between child elements.',
  'manualEdit.shape.directionHelp': 'Axis along which children are arranged.',
  'manualEdit.shape.justifyHelp': 'Places children along the main axis.',
  'manualEdit.shape.alignHelp': 'Places children along the cross axis.',
  'manualEdit.typography.bold': 'Bold',
  'manualEdit.typography.italic': 'Italic',
  'manualEdit.typography.underline': 'Underline',
  'manualEdit.typography.font': 'Font',
  'manualEdit.typography.fontSize': 'Font size',
  'manualEdit.typography.weight': 'Weight',
  'manualEdit.typography.textColor': 'Text color',
  'manualEdit.typography.textColorValue': 'Text color value',
  'manualEdit.typography.alignLeft': 'Align left',
  'manualEdit.typography.alignCenter': 'Align center',
  'manualEdit.typography.alignRight': 'Align right',
  'manualEdit.typography.alignJustify': 'Justify',
  'manualEdit.typography.lineHeight': 'Line height',
  'manualEdit.typography.letterSpacing': 'Letter spacing',
  'manualEdit.typography.increase': 'Increase',
  'manualEdit.typography.decrease': 'Decrease',
  'manualEdit.typography.style': 'Style',
  'manualEdit.typography.alignment': 'Alignment',
  'manualEdit.typography.fontHelp': 'Typeface used by the selected text.',
  'manualEdit.typography.fontSizeHelp': 'Height of the text in pixels.',
  'manualEdit.typography.styleHelp': 'Applies to the current text selection.',
  'manualEdit.typography.weightHelp': 'Thickness of the letter strokes.',
  'manualEdit.typography.textColorHelp': 'Color of the selected text element.',
  'manualEdit.typography.alignmentHelp': 'Horizontal placement of text in its box.',
  'manualEdit.typography.lineHeightHelp': 'Vertical space occupied by each line.',
  'manualEdit.typography.letterSpacingHelp': 'Extra horizontal space between letters.',
  'manualEdit.resize.nw': 'Resize top-left corner',
  'manualEdit.resize.n': 'Resize top edge',
  'manualEdit.resize.ne': 'Resize top-right corner',
  'manualEdit.resize.e': 'Resize right edge',
  'manualEdit.resize.se': 'Resize bottom-right corner',
  'manualEdit.resize.s': 'Resize bottom edge',
  'manualEdit.resize.sw': 'Resize bottom-left corner',
  'manualEdit.resize.w': 'Resize left edge',
  'manualEdit.resize.frameLabel': 'Resize element',
  'manualEdit.move.frame': 'Move element',
  'manualEdit.move.left': 'Moved left {amount}px',
  'manualEdit.move.right': 'Moved right {amount}px',
  ...
  'fileViewer.standaloneExportSuccess': 'Standalone HTML downloaded',
  'fileViewer.standaloneExportExternal': 'Downloaded with {count} external reference(s)',
  'fileViewer.standaloneExportMissing': 'Downloaded with {count} missing local asset(s)',
  'fileViewer.standaloneExportExternalAndMissing': 'Downloaded with {external} external and {missing} missing local reference(s)',
  'fileViewer.standaloneExportFailed': 'Could not export standalone HTML',
  'fileViewer.standaloneExportTooLarge': 'This HTML is too large to export',
  ...
  'assistant.rollbackConversation': 'Rollback from here',
  'rollback.title': 'Rollback checkpoint',
  'rollback.subtitle': 'Choose what to restore from this chat point.',
  'rollback.targetLabel': 'Target',
  'rollback.modeLabel': 'Restore mode',
  'rollback.mode.filesOnly': 'Files only',
  'rollback.mode.chatOnly': 'Chat only',
  'rollback.mode.filesAndChat': 'Files and chat',
  'rollback.diffSummary': 'File change summary',
  'rollback.diffAdded': 'Added',
  'rollback.diffModified': 'Modified',
  'rollback.diffDeleted': 'Deleted',
  'rollback.diffConflicts': 'Conflicts',
  'rollback.fileListTitle': 'Affected files',
  'rollback.loading': 'Loading checkpoint...',
  'rollback.loadFailed': 'Could not load checkpoint details.',
  'rollback.safetyNotice': 'Readable Studio creates a safety checkpoint before changing files or chat.',
  ...
  'rollback.agentRequestMode': 'Restore mode',
  'rollback.agentRequestAccept': 'Accept',
  'rollback.agentRequestReject': 'Reject',
  'rollback.agentRequestDiff': 'Show diff',
  'rollback.agentRequestAcceptAria': 'Accept the rollback request and restore the selected checkpoint',
  'rollback.agentRequestRejectAria': 'Reject the rollback request and keep the current files',
  'rollback.agentRequestDiffAria': 'Preview the differences before deciding on the rollback',
  'rollback.agentRequestRejected': 'You chose to keep the current files.',
  'rollback.agentRequestExpired': 'This rollback request has expired.',
  ...
  'qf.lockedQueued': 'Answers queued — the agent will use them when the current run finishes.',
  ...
  'questions.hydratingRuns': 'Checking the current run before continuing. Your answers are kept.',
  'questions.runHydrationFailed': 'Could not check the current run. Your answers are kept. Retry to continue.',
  'questions.retryRunHydration': 'Retry run check',
  'questions.willQueue': 'Answers will be queued and applied when the current run finishes.',
  'questions.queued': 'Answers queued for the next turn.',
  ...
  'pet.tabBuiltInHint': 'Curated companions bundled with Readable Studio — pick one and adopt.',
  ...
  'pet.slashSearch': 'Search the web through the Readable Studio research command.',
  ...
  'pet.codexBundledTitle': 'Ships with Readable Studio — no download needed.',
  'systemPrompts.nav': 'System prompts',
  'systemPrompts.navHint': 'Edit the product prompts that drive decks, reports and prototypes',
  'systemPrompts.title': 'System prompts',
  'systemPrompts.description':
    'These templates drive artifact-specific behaviour. Your edits are stored as overrides and product updates never overwrite them. Reset any prompt to return to the shipped default.',
  'systemPrompts.loading': 'Loading system prompts…',
  'systemPrompts.loadError': 'Could not load system prompts.',
  'systemPrompts.retry': 'Try again',
  'systemPrompts.empty': 'No editable system prompts are available.',
  'systemPrompts.overridden': 'Customized',
  'systemPrompts.usingDefault': 'Using default',
  'systemPrompts.editorLabel': 'Prompt template',
  'systemPrompts.requiredPlaceholders': 'Required placeholders',
  'systemPrompts.requiredPlaceholdersHint':
    'These slots are filled in at run time. Keep each one exactly once — saving is blocked while any is missing or repeated.',
  'systemPrompts.placeholderPresent': '{name} — present once',
  'systemPrompts.placeholderMissing': '{name} — missing, add it back before saving',
  'systemPrompts.placeholderDuplicated': '{name} — appears {count} times, keep only one',
  'systemPrompts.blockedBeforeSave':
    'Fix the required placeholders above before saving.',
  'systemPrompts.save': 'Save',
  'systemPrompts.saving': 'Saving…',
  'systemPrompts.saved': 'Saved.',
  'systemPrompts.reset': 'Reset to default',
  'systemPrompts.resetting': 'Resetting…',
  'systemPrompts.resetDone': 'Restored the shipped default.',
  'systemPrompts.unsaved': 'Unsaved changes',
  'systemPrompts.validationMissing':
    'Not saved. The required placeholder {names} is missing from the prompt — add it back and save again.',
  'systemPrompts.validationDuplicate':
    'Not saved. The required placeholder {names} appears more than once — keep exactly one and save again.',
  'systemPrompts.saveFailed': 'Could not save this prompt. Your edit was not applied.',
  'systemPrompts.resetFailed': 'Could not reset this prompt. The current prompt is unchanged.',

  'settings.featureFlags': 'Workspace features',
  'settings.featureFlagsHint': 'Turn optional preview tools on or off',
  'settings.featureFlagsTitle': 'Workspace features',
  'settings.featureFlagsDescription':
    'Optional preview tools. Both stay hidden until you switch them on here.',
  'settings.featureFlagScreenshot': 'Screenshot',
  'settings.featureFlagScreenshotHint':
    'Shows the screenshot action in the preview toolbar so you can copy the current view as an image. Off by default.',
  'settings.featureFlagViewportSelector': 'Viewport selector',
  'settings.featureFlagViewportSelectorHint':
    'Shows the desktop / tablet / mobile selector in the preview toolbar. Off by default.',
  ...
  'settings.projectLocationsDescription': 'Add work bases that can contain multiple Readable Studio project folders. New projects are saved as one folder inside the selected base.',
  'settings.databricksModels': 'Databricks models',
  'settings.databricksModelsHint': 'Registered workspace endpoints',
  'settings.databricksModelsDescription': 'Models you registered from a Databricks workspace. Remove one to drop it from the model picker, or disconnect a workspace to forget its connection and every model registered from it.',
  'settings.databricksModelsEmptyTitle': 'No Databricks models registered',
  'settings.databricksModelsEmptyHint': 'Open the model picker in the composer and choose "Add models" to scan a workspace and register endpoints.',
  'settings.databricksModelsCount': '{count} registered',
  'settings.databricksModelsContext': 'Context {value}',
  'settings.databricksModelsOutput': 'Output {value}',
  'settings.databricksModelsLimitUnknown': 'Limit unknown',
  'settings.databricksRemove': 'Remove',
  'settings.databricksRemoveConfirm': 'Confirm remove',
  'settings.databricksDisconnect': 'Disconnect workspace',
  'settings.databricksDisconnectConfirm': 'Confirm disconnect',
  ...
  'settings.customInstructionsHint': 'Fixed instructions Readable Studio should follow in every chat. Save facts, preferences, and project context as memories.',
  ...
  'settings.memoryEmptyHintBefore': 'Tell the assistant a fact in chat — e.g.',
  'settings.memoryEmptyExample': 'I prefer dark mode',
  'settings.memoryEmptyHintAfter': '— and it will be saved here automatically.',
  'settings.memoryStoragePathAria': 'Memory storage path — click to copy',
  'settings.memoryAreasAria': 'Memory areas',
  'settings.memoryTabManual': 'Add manually',
  'settings.memoryTabManualCaption': 'Write a fact or preference',
  'settings.memoryTabChat': 'Learn from chats',
  'settings.memoryTabChatCaption': 'Capture useful context',
  'settings.memoryManualDescription': 'Add facts, preferences, or project context yourself. Fixed assistant behavior lives in Instructions / Rules.',
  'settings.memoryChatDescription': 'Readable Studio can learn preferences and project facts from future chat turns.',
  'settings.memoryChatToggleAria': 'Learn from chat conversations',
  'settings.memoryOn': 'On',
  'settings.memoryOff': 'Off',
  'settings.memorySavedTitle': 'Saved memory',
  'settings.memorySavedHint': 'Saved facts, preferences, and project context available to future chats.',
  'settings.memorySavedCount': '{count} saved',
  'settings.memoryExtractionCountOne': '{count} extraction',
  'settings.memoryExtractionCountMany': '{count} extractions',
  'settings.memoryTree': 'Memory tree',
  'settings.memoryTreeNodeCountOne': '{count} node',
  'settings.memoryTreeNodeCountMany': '{count} nodes',
  'settings.memoryAdvanced': 'Advanced',
  'settings.memoryAdvancedHint': 'Inspect or edit the underlying memory index.',
  ...
  'settings.memoryStarterProjectDesc': 'Readable Studio — source text to standalone HTML',
  ...
  'settings.memoryExtractionSkipChatDisabled': 'Chat conversation learning is off.',
  ...
  'settings.memoryExtractionWrittenCount': '{count} written',
  'settings.memoryExtractionFailureAuth': '{provider} authentication expired',
  'settings.memoryExtractionFailureQuota': '{provider} quota or rate limit hit',
  'settings.memoryExtractionFailureRequest': '{provider} request failed',
  'settings.memoryExtractionFailureGeneric': 'Memory extraction failed',
  'settings.memoryExtractionFailureSource': 'Readable Studio could not run memory extraction for this chat.',
  'settings.memoryExtractionActionCliAuth': 'Sign in to the selected Local CLI or choose a different Memory model.',
  'settings.memoryExtractionActionModelAuth': 'Update the Memory extraction model key or sign in again.',
  'settings.memoryExtractionActionQuota': 'Try again later or switch the Memory extraction model.',
  'settings.memoryExtractionActionCliRequest': 'Check the selected Local CLI and try again.',
  'settings.memoryExtractionActionProviderRequest': 'Check the model provider connection and try again.',
  'settings.memoryExtractionActionCliGeneric': 'Try again after checking the selected Local CLI.',
  'settings.memoryExtractionActionModelGeneric': 'Try again after checking the Memory extraction model settings.',
  ...
  'settings.memoryNoProviderBannerBody': 'No API key found for the memory extractor. Set ANTHROPIC_API_KEY or OPENAI_API_KEY in the environment, or configure the daemon media config file, to enable LLM-driven extraction. Heuristic regex extraction is still active.',
  ...
  'automations.lede': 'Plan recurring conversations for project work, routines, and live artifacts.',
  ...
  'automations.templatesSub': 'Live artifacts are templates inside the same automation flow.',
  ...
  'dsManager.createBody': 'Teach Readable Studio your brand, product, code, assets, and design references.',
  ...
  'settings.customInstructionsDesc': 'Fixed instructions Readable Studio follows in every chat. These are not saved memories; use Memory for facts, preferences, and project context.',
