...
export const en: Dict = {
  ...
  'brief.description': 'These assumptions guide the work. Select any item to correct it.',
  'brief.collapse': 'Collapse project brief',
  'brief.backToSummary': 'Back to project brief',
  'brief.assumptions': 'Project assumptions',
  'brief.provenance.stated': 'Stated by you',
  ...
  'brief.field.output': 'Output',
  'brief.field.platform': 'Platform',
  'brief.field.audience': 'Audience',
  'brief.field.tone': 'Visual tone',
  'brief.field.brand': 'Brand',
  'brief.field.scale': 'Scale',
  'brief.field.language': 'Language',
  'brief.field.constraints': 'Constraints',
  'brief.field.fidelity': 'Fidelity',
  'brief.field.platformTargets': 'Target platforms',
  'brief.field.companionSurfaces': 'Companion surfaces',
  'brief.field.speakerNotes': 'Speaker notes',
  'brief.field.animations': 'Animations',
  'brief.question.output': 'What are we making?',
  'brief.question.platform': 'Target platform',
  'brief.question.audience': 'Who is this for?',
  'brief.question.tone': 'Visual tone',
  'brief.question.brand': 'Brand context',
  'brief.question.scale': 'Roughly how much?',
  'brief.question.language': 'Content language',
  'brief.question.constraints': 'Important constraints',
  'brief.placeholder.audience': 'e.g. dev-tools buyers',
  'brief.placeholder.scale': 'e.g. 8 slides or 4 mobile screens',
  'brief.placeholder.constraints': 'Real copy, required fonts, things to avoid…',
  'brief.option.slideDeck': 'Slide deck / pitch',
  'brief.option.singlePrototype': 'Single web prototype / landing',
  'brief.option.multiPrototype': 'Multi-screen app prototype',
  'brief.option.dashboard': 'Dashboard / tool UI',
  'brief.option.editorial': 'Editorial / marketing page',
  'brief.option.other': 'Other',
  'brief.option.fixedCanvas': 'Fixed canvas (1920×1080)',
  'brief.option.toneEditorial': 'Editorial / magazine',
  'brief.option.toneMinimal': 'Modern minimal',
  'brief.option.tonePlayful': 'Playful / illustrative',
  'brief.option.toneTech': 'Tech / utility',
  'brief.option.toneLuxury': 'Luxury / refined',
  'brief.option.toneBrutalist': 'Brutalist / experimental',
  'brief.option.toneHuman': 'Human / approachable',
  'brief.option.pickDirection': 'Pick a direction for me',
  'brief.option.brandSpec': 'I have a brand spec - I will share it',
  'brief.option.referenceMatch': 'Match a reference site or screenshot',
  'brief.option.included': 'Included',
  'brief.option.notIncluded': 'Not included',
  ...
  'hub.startHint': 'Every project and session lives in the left list.',
  'hub.startHintContinuation': 'to find anything from anywhere.',
  ...
  'useEverywhere.modalAria': 'Use Readable Studio everywhere',
  'useEverywhere.modalTitle': 'Use Readable Studio everywhere',
  'useEverywhere.modalSubtitle': 'Drop Readable Studio into any IDE, agent, or script — CLI, HTTP, MCP, and Skills. Use “Copy guide for an agent” and paste into Claude Code, Codex, Cursor, openclaw, or hermes to set up everything.',
