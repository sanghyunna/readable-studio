...
export const en: Dict = {
  ...
  'questions.field.output': 'Output',
  'questions.field.platform': 'Platform',
  'questions.field.audience': 'Audience',
  'questions.field.tone': 'Visual tone',
  'questions.field.brand': 'Brand',
  'questions.field.scale': 'Scale',
  'questions.field.language': 'Language',
  'questions.field.constraints': 'Constraints',
  'questions.field.fidelity': 'Fidelity',
  'questions.field.platformTargets': 'Target platforms',
  'questions.field.companionSurfaces': 'Companion surfaces',
  'questions.field.speakerNotes': 'Speaker notes',
  'questions.field.animations': 'Animations',
  'questions.question.output': 'What are we making?',
  'questions.question.platform': 'Target platform',
  'questions.question.audience': 'Who is this for?',
  'questions.question.tone': 'Visual tone',
  'questions.question.brand': 'Brand context',
  'questions.question.scale': 'Roughly how much?',
  'questions.question.language': 'Content language',
  'questions.question.constraints': 'Important constraints',
  'questions.placeholder.audience': 'e.g. dev-tools buyers',
  'questions.placeholder.scale': 'e.g. 8 slides or 4 mobile screens',
  'questions.placeholder.constraints': 'Real copy, required fonts, things to avoid…',
  'questions.option.slideDeck': 'Slide deck / pitch',
  'questions.option.singlePrototype': 'Single web prototype / landing',
  'questions.option.multiPrototype': 'Multi-screen app prototype',
  'questions.option.dashboard': 'Dashboard / tool UI',
  'questions.option.editorial': 'Editorial / marketing page',
  'questions.option.other': 'Other',
  'questions.option.fixedCanvas': 'Fixed canvas (1920×1080)',
  'questions.option.toneEditorial': 'Editorial / magazine',
  'questions.option.toneMinimal': 'Modern minimal',
  'questions.option.tonePlayful': 'Playful / illustrative',
  'questions.option.toneTech': 'Tech / utility',
  'questions.option.toneLuxury': 'Luxury / refined',
  'questions.option.toneBrutalist': 'Brutalist / experimental',
  'questions.option.toneHuman': 'Human / approachable',
  'questions.option.pickDirection': 'Pick a direction for me',
  'questions.option.brandSpec': 'I have a brand spec - I will share it',
  'questions.option.referenceMatch': 'Match a reference site or screenshot',
  'questions.option.included': 'Included',
  'questions.option.notIncluded': 'Not included',
