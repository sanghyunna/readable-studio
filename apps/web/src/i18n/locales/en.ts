...
export const en: Dict = {
  ...
  'hub.startSubtitle': 'Paste your source text or describe the document. After the draft you can edit it directly in the preview and export standalone HTML.',
  'hub.composerPlaceholder': 'e.g. Turn the attached results into an executive quarterly report.',
  'hub.context': 'Context',
  'hub.noTemplate': 'No template',
  'hub.send': 'Start',
