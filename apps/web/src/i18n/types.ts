...
export interface Dict {
  ...
  'questions.field.output': string;
  'questions.field.platform': string;
  'questions.field.audience': string;
  'questions.field.tone': string;
  'questions.field.brand': string;
  'questions.field.scale': string;
  'questions.field.language': string;
  'questions.field.constraints': string;
  'questions.field.fidelity': string;
  'questions.field.platformTargets': string;
  'questions.field.companionSurfaces': string;
  'questions.field.speakerNotes': string;
  'questions.field.animations': string;
  'questions.question.output': string;
  'questions.question.platform': string;
  'questions.question.audience': string;
  'questions.question.tone': string;
  'questions.question.brand': string;
  'questions.question.scale': string;
  'questions.question.language': string;
  'questions.question.constraints': string;
  'questions.placeholder.audience': string;
  'questions.placeholder.scale': string;
  'questions.placeholder.constraints': string;
  'questions.option.slideDeck': string;
  'questions.option.singlePrototype': string;
  'questions.option.multiPrototype': string;
  'questions.option.dashboard': string;
  'questions.option.editorial': string;
  'questions.option.other': string;
  'questions.option.fixedCanvas': string;
  'questions.option.toneEditorial': string;
  'questions.option.toneMinimal': string;
  'questions.option.tonePlayful': string;
  'questions.option.toneTech': string;
  'questions.option.toneLuxury': string;
  'questions.option.toneBrutalist': string;
  'questions.option.toneHuman': string;
  'questions.option.pickDirection': string;
  'questions.option.brandSpec': string;
  'questions.option.referenceMatch': string;
  'questions.option.included': string;
  'questions.option.notIncluded': string;
