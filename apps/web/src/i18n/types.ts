...
export interface Dict {
  ...
  'questions.backToSummary': string;
  'questions.assumptions': string;
  'questions.ledgerTrigger': string;
  'questions.provenance.stated': string;
  'questions.provenance.inferred': string;
  'questions.provenance.default': string;
  'questions.assumptionLabel': string;
  'questions.influence': string;
  'questions.correctTitle': string;
  'questions.correctionDescription': string;
  'questions.applyCorrection': string;
  'systemPrompts.designerCharter.label': string;
  'systemPrompts.designerCharter.description': string;
  'systemPrompts.discoveryWorkflow.label': string;
  'systemPrompts.discoveryWorkflow.description': string;
  'systemPrompts.deckFramework.label': string;
  'systemPrompts.deckFramework.description': string;
  ...
  'settings.codeAgentCurrent': string;
  'settings.codeAgentNotChecked': string;
  'settings.codeAgentAvailable': string;
  'settings.codeAgentUnavailable': string;
  ...
  'settings.databricksModels': string;
  'settings.databricksModelsHint': string;
  'settings.databricksModelsDescription': string;
  'settings.databricksModelsEmptyTitle': string;
  'settings.databricksModelsEmptyHint': string;
  'settings.databricksModelsCount': string;
  'settings.databricksModelsContext': string;
  'settings.databricksModelsOutput': string;
  'settings.databricksModelsLimitUnknown': string;
  'settings.databricksRemove': string;
  'settings.databricksRemoveConfirm': string;
  'settings.databricksDisconnect': string;
  'settings.databricksDisconnectConfirm': string;
  ...
  'settings.memoryEmptyHintBefore': string;
  'settings.memoryEmptyExample': string;
  'settings.memoryEmptyHintAfter': string;
  'settings.memoryStoragePathAria': string;
  'settings.memoryAreasAria': string;
  'settings.memoryTabManual': string;
  'settings.memoryTabManualCaption': string;
  'settings.memoryTabChat': string;
  'settings.memoryTabChatCaption': string;
  'settings.memoryManualDescription': string;
  'settings.memoryChatDescription': string;
  'settings.memoryChatToggleAria': string;
  'settings.memoryOn': string;
  'settings.memoryOff': string;
  'settings.memorySavedTitle': string;
  'settings.memorySavedHint': string;
  'settings.memorySavedCount': string;
  'settings.memoryExtractionCountOne': string;
  'settings.memoryExtractionCountMany': string;
  'settings.memoryTree': string;
  'settings.memoryTreeNodeCountOne': string;
  'settings.memoryTreeNodeCountMany': string;
  'settings.memoryAdvanced': string;
  'settings.memoryAdvancedHint': string;
  ...
  'settings.memoryExtractionSkipChatDisabled': string;
  ...
  'settings.memoryExtractionWrittenCount': string;
  'settings.memoryExtractionFailureAuth': string;
  'settings.memoryExtractionFailureQuota': string;
  'settings.memoryExtractionFailureRequest': string;
  'settings.memoryExtractionFailureGeneric': string;
  'settings.memoryExtractionFailureSource': string;
  'settings.memoryExtractionActionCliAuth': string;
  'settings.memoryExtractionActionModelAuth': string;
  'settings.memoryExtractionActionQuota': string;
  'settings.memoryExtractionActionCliRequest': string;
  'settings.memoryExtractionActionProviderRequest': string;
  'settings.memoryExtractionActionCliGeneric': string;
  'settings.memoryExtractionActionModelGeneric': string;
  ...
  'hub.paletteSearch': string;
  'hub.paletteNoResults': string;
  'hub.paletteMove': string;
  'hub.paletteActivate': string;
  'hub.paletteClose': string;
  'hub.filterLabel': string;
  'hub.filterAll': string;
  'hub.filterAttention': string;
  ...
  'hub.dropToEditLabel': string;
  'hub.dropToEditDetail': string;
  'hub.dropToEditRelease': string;
  'hub.dropToEditBusy': string;
  'hub.dropUnsupported': string;
  'hub.dropOneAtATime': string;
  'hub.dropImportFailed': string;
  ...
  'hub.theme': string;
  'hub.themeSubtitle': string;
  'hub.themeDone': string;
  ...
  'homeHero.chip.report': string;
  'homeHero.chip.reportHint': string;
  'projectFolderPicker.homeTitle': string;
  'projectFolderPicker.processing': string;
  'projectFolderPicker.select': string;
  'projectFolderPicker.clearAria': string;
  ...
  'databricks.modal.checkingCli': string;
  'databricks.modal.checkAgain': string;
  'databricks.modal.installCli': string;
  'databricks.modal.docs': string;
  'databricks.cli.missingTitle': string;
  'databricks.cli.missingBody': string;
  'databricks.cli.unsupportedTitle': string;
  'databricks.cli.unsupportedBody': string;
  'databricks.cli.uninvocableTitle': string;
  'databricks.cli.uninvocableBody': string;
  'databricks.auth.requiredTitle': string;
  'databricks.auth.requiredBody': string;
  'databricks.auth.keyringTitle': string;
  'databricks.auth.keyringBody': string;
  'databricks.auth.unreachableTitle': string;
  'databricks.auth.unreachableBody': string;
  'databricks.auth.unsupportedTitle': string;
  'databricks.auth.unsupportedBody': string;
  'databricks.profiles.label': string;
  'databricks.profiles.none': string;
  'databricks.profiles.default': string;
  'databricks.profiles.authenticated': string;
  'databricks.profiles.authRequired': string;
  'databricks.profiles.unchecked': string;
  'databricks.profiles.checking': string;
  'databricks.setup.label': string;
  'databricks.setup.intro': string;
  'databricks.setup.hostLabel': string;
  'databricks.setup.hostHint': string;
  'databricks.setup.hostInvalid': string;
  'databricks.setup.tokenLabel': string;
  'databricks.setup.tokenHint': string;
  'databricks.setup.submit': string;
  'databricks.setup.submitting': string;
  ...
  'databricks.scan.rescan': string;
  'databricks.scan.cancel': string;
  'databricks.scan.running': string;
  'databricks.scan.complete': string;
  'databricks.scan.failed': string;
  'databricks.scan.cancelled': string;
  'databricks.scan.progress': string;
  'databricks.scan.empty': string;
  'databricks.scan.signInFirst': string;
  'databricks.scan.partialTitle': string;
  'databricks.scan.partialBody': string;
  'databricks.scan.truncatedBody': string;
  'databricks.results.title': string;
  'databricks.results.registeredCount': string;
  ...
  'databricks.api.anthropic': string;
  'databricks.api.unknown': string;
  'databricks.availability.compatible': string;
  'databricks.availability.verificationRequired': string;
  ...
  'databricks.issue.signIn': string;
  'databricks.issue.rescan': string;
  'databricks.issue.verify': string;
  'databricks.issue.checkPermissions': string;
  'databricks.error.generic': string;
  'databricks.registeredNote': string;
  ...
  'workspace.unsavedTabCloseBlocked': string;
  ...
  'fileViewer.commentOnElement': string;
  'fileViewer.previewToolsAria': string;
  'fileViewer.sendToLlm': string;
  'fileViewer.directEdit': string;
  ...
  'manualEdit.quickFormat': string;
  'manualEdit.quickShape': string;
  'manualEdit.sizePosition': string;
  'manualEdit.sectionTextDescription': string;
  'manualEdit.sectionShapeDescription': string;
  'manualEdit.groupAppearance': string;
  'manualEdit.groupSize': string;
  'manualEdit.groupSpacing': string;
  'manualEdit.groupBorder': string;
  'manualEdit.groupLayout': string;
  ...
  'manualEdit.page': string;
  'manualEdit.pageStyles': string;
  'manualEdit.baseSize': string;
  'manualEdit.pageStylesUnavailable': string;
  'manualEdit.error.previewStyleFailed': string;
  'manualEdit.error.selectedTargetMissing': string;
  'manualEdit.error.stylesReconciled': string;
  'manualEdit.error.duplicatePreviewFailed': string;
  'manualEdit.error.finishBeforeDuplicateFailed': string;
  'manualEdit.error.saveBeforeDuplicateFailed': string;
  ...
  'manualEdit.error.applyFailed': string;
  'manualEdit.error.fileChangedBeforeUndo': string;
  'manualEdit.error.fileChangedBeforeRedo': string;
  'manualEdit.error.invalidStyleValue': string;
  ...
  'manualEdit.shape.paddingTop': string;
  'manualEdit.shape.paddingRight': string;
  'manualEdit.shape.paddingBottom': string;
  'manualEdit.shape.paddingLeft': string;
  'manualEdit.shape.spacing': string;
  'manualEdit.spacing.selectedElement': string;
  'manualEdit.spacing.selectPadding': string;
  'manualEdit.spacing.selectMargin': string;
  'manualEdit.spacing.linkAll': string;
  'manualEdit.spacing.resetAll': string;
  'manualEdit.spacing.editing': string;
  'manualEdit.spacing.diagramHint': string;
  'manualEdit.geometry.sizing': string;
  'manualEdit.geometry.position': string;
  'manualEdit.geometry.modes': string;
  'manualEdit.geometry.auto': string;
  'manualEdit.geometry.fixed': string;
  'manualEdit.geometry.fill': string;
  'manualEdit.geometry.keepAspect': string;
  'manualEdit.geometry.inFlow': string;
  'manualEdit.geometry.directMove': string;
  'manualEdit.geometry.flowTitle': string;
  'manualEdit.geometry.flowHelp': string;
  'manualEdit.geometry.directTitle': string;
  'manualEdit.geometry.directHelp': string;
  'manualEdit.geometry.offsetX': string;
  'manualEdit.geometry.offsetY': string;
  'manualEdit.geometry.resetPosition': string;
  'manualEdit.shape.margin': string;
  'manualEdit.shape.marginTop': string;
  'manualEdit.shape.marginRight': string;
  'manualEdit.shape.marginBottom': string;
  'manualEdit.shape.marginLeft': string;
  'manualEdit.shape.border': string;
  'manualEdit.shape.borderWidths': string;
  'manualEdit.shape.borderWidthsTop': string;
  'manualEdit.shape.borderWidthsRight': string;
  'manualEdit.shape.borderWidthsBottom': string;
  'manualEdit.shape.borderWidthsLeft': string;
  'manualEdit.shape.borderColor': string;
  'manualEdit.shape.style': string;
  'manualEdit.shape.radius': string;
  'manualEdit.shape.opacity': string;
  'manualEdit.shape.layout': string;
  'manualEdit.shape.gap': string;
  'manualEdit.shape.direction': string;
  'manualEdit.shape.justify': string;
  'manualEdit.shape.align': string;
  'manualEdit.shape.more': string;
  'manualEdit.shape.fillHelp': string;
  'manualEdit.shape.widthHelp': string;
  'manualEdit.shape.heightHelp': string;
  'manualEdit.shape.paddingHelp': string;
  'manualEdit.shape.marginHelp': string;
  'manualEdit.shape.borderWidthsHelp': string;
  'manualEdit.shape.borderColorHelp': string;
  'manualEdit.shape.styleHelp': string;
  'manualEdit.shape.radiusHelp': string;
  'manualEdit.shape.opacityHelp': string;
  'manualEdit.shape.groupSurface': string;
  'manualEdit.shape.groupGeometry': string;
  'manualEdit.shape.borderWidthAll': string;
  'manualEdit.shape.borderWidthsPerSide': string;
  'manualEdit.shape.borderStyleDefault': string;
  'manualEdit.shape.borderStyleSolid': string;
  'manualEdit.shape.borderStyleDashed': string;
  'manualEdit.shape.borderStyleDotted': string;
  'manualEdit.shape.borderStyleDouble': string;
  'manualEdit.shape.borderStyleNone': string;
  'manualEdit.shape.dangerZone': string;
  'manualEdit.shape.gapHelp': string;
  'manualEdit.shape.directionHelp': string;
  'manualEdit.shape.justifyHelp': string;
  'manualEdit.shape.alignHelp': string;
  'manualEdit.typography.bold': string;
  'manualEdit.typography.italic': string;
  'manualEdit.typography.underline': string;
  'manualEdit.typography.font': string;
  'manualEdit.typography.fontSize': string;
  'manualEdit.typography.weight': string;
  'manualEdit.typography.textColor': string;
  'manualEdit.typography.textColorValue': string;
  'manualEdit.typography.alignLeft': string;
  'manualEdit.typography.alignCenter': string;
  'manualEdit.typography.alignRight': string;
  'manualEdit.typography.alignJustify': string;
  'manualEdit.typography.lineHeight': string;
  ...
  'manualEdit.typography.fontHelp': string;
  'manualEdit.typography.fontSizeHelp': string;
  'manualEdit.typography.styleHelp': string;
  'manualEdit.typography.weightHelp': string;
  'manualEdit.typography.textColorHelp': string;
  'manualEdit.typography.alignmentHelp': string;
  'manualEdit.typography.lineHeightHelp': string;
  'manualEdit.typography.letterSpacingHelp': string;
  ...
  'assistant.rollbackConversation': string;
  'rollback.title': string;
  'rollback.subtitle': string;
  'rollback.targetLabel': string;
  'rollback.modeLabel': string;
  'rollback.mode.filesOnly': string;
  'rollback.mode.chatOnly': string;
  'rollback.mode.filesAndChat': string;
  'rollback.diffSummary': string;
  'rollback.diffAdded': string;
  'rollback.diffModified': string;
  'rollback.diffDeleted': string;
  'rollback.diffConflicts': string;
  'rollback.fileListTitle': string;
  'rollback.loading': string;
  'rollback.loadFailed': string;
  'rollback.safetyNotice': string;
  'rollback.conflictPolicyLabel': string;
  'rollback.conflictPolicyFail': string;
