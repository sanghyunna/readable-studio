...
export interface Dict {
  ...
  'brief.field.output': string;
  'brief.field.platform': string;
  'brief.field.audience': string;
  'brief.field.tone': string;
  'brief.field.brand': string;
  'brief.field.scale': string;
  'brief.field.language': string;
  'brief.field.constraints': string;
  'brief.field.fidelity': string;
  'brief.field.platformTargets': string;
  'brief.field.companionSurfaces': string;
  'brief.field.speakerNotes': string;
  'brief.field.animations': string;
  'brief.question.output': string;
  'brief.question.platform': string;
  'brief.question.audience': string;
  'brief.question.tone': string;
  'brief.question.brand': string;
  'brief.question.scale': string;
  'brief.question.language': string;
  'brief.question.constraints': string;
  'brief.placeholder.audience': string;
  'brief.placeholder.scale': string;
  'brief.placeholder.constraints': string;
  'brief.option.slideDeck': string;
  'brief.option.singlePrototype': string;
  'brief.option.multiPrototype': string;
  'brief.option.dashboard': string;
  'brief.option.editorial': string;
  'brief.option.other': string;
  'brief.option.fixedCanvas': string;
  'brief.option.toneEditorial': string;
  'brief.option.toneMinimal': string;
  'brief.option.tonePlayful': string;
  'brief.option.toneTech': string;
  'brief.option.toneLuxury': string;
  'brief.option.toneBrutalist': string;
  'brief.option.toneHuman': string;
  'brief.option.pickDirection': string;
  'brief.option.brandSpec': string;
  'brief.option.referenceMatch': string;
  'brief.option.included': string;
  'brief.option.notIncluded': string;
