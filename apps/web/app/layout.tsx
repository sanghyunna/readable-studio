...
import { DEFAULT_THEME, THEME_SCHEME_BY_ID } from '../src/state/themes';
import { PERFORMANCE_PROFILE_ATTRIBUTE } from '../src/state/config';
 ...
 * and performance profile without a flash of unstyled content. It reads the same
