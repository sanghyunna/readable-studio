...
// tsconfig does not resolve the `@readable-studio/contracts/api/chat` subpath
...
} from '@readable-studio/contracts/api/finalize';
...
// canonical definitions live in @readable-studio/contracts/api/finalize
