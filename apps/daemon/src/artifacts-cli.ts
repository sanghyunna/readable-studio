...
const USAGE = `Usage:
  readable artifacts create --name <path> --input <file> [--project <id-or-name>] [--manifest artifact.json] [--encoding utf8|base64] [--daemon-url <url>]

Creates one normal Readable Studio project artifact entry file through the local daemon.
When --project is omitted, the active Readable Studio project is used.
