...
import type { HandoffRequest, HandoffResponse } from '@readable-studio/contracts/api/handoff';
...
const USAGE = `Usage:
  readable project handoff <projectId> --conversation <id> --api-key <key> --model <model>
