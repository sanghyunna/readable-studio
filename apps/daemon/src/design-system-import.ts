...
function renderUsageMd(name: string, scan: ProjectScan): string {
  ...
  return [
    `# ${name} Usage`,
    '',
    '> Auto-generated by the Readable Studio importer. Review and edit before treating it as a canonical brand guide.',
    '',
    '## Read Order',
    '',
    ...
    '## Design Highlights',
    '',
    ...(highlights.length > 0 ? highlights.map((line) => `- ${line}`) : ['- Imported web design system with generated Readable Studio tokens.']),
    '',
    '## Do',
    '',
    '- Preserve semantic roles from the source project before inventing new values.',
    '- Use `tokens.css` as the normalized Readable Studio token contract.',
    ...
    '- Do not rename Readable Studio standard tokens in generated artifacts.',
    '',
  ].join('\n');
}
