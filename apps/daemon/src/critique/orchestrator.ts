...
import type { CritiqueConfig, PanelEvent } from '@readable-studio/contracts/critique';
import { panelEventToSse } from '@readable-studio/contracts/critique';
...
const tracer = trace.getTracer('@readable-studio/daemon/critique');
