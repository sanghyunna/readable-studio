...
// REASONIX_ACP_SYSTEM_APPEND. This ensures the model follows Readable Studio's
// design workflow (artifact output, design system, skill instructions)
// instead of treating every request as a pure coding task.
const DESIGN_INSTRUCTIONS = `# Readable Studio integration — MUST follow

You are running inside Readable Studio, a design tool. The user message contains
