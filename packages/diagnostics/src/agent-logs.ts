...
export interface AgentCliLogOptions {
  ...
  homeDir: string;
  /** Readable Studio data dir (READABLE_DATA_DIR); fallback location of the AMR OpenCode home. */
  dataDir?: string | null;
  /**
...
/**
 * Collect the native on-disk logs of the coding-agent CLIs Readable Studio drives:
