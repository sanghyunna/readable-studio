...
**License:** MIT
**Alternate filename:** This file contains the English runtime documentation.

![html-ppt — cover with live previews](https://repo-assets.readable-studio.ai/resources/images/design-templates/html-ppt/hero.gif)
