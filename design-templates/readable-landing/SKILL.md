...
parameters:
  output_format:
    ...
    description: >
      Writes one self-contained .html with inlined CSS and scripts and
...
sibling [`readable-landing-deck`](../readable-landing-deck/) skill)
...
This is the canonical Readable Studio marketing-page recipe — the example
output is the very page you see at [readable-studio](https://github.com/sanghyunna/readable-studio).
...
worked example (Readable Studio itself).
...
- All section markup with `data-reveal` attributes for staggered
  scroll motion.
- Inline IntersectionObserver script for reveal motion.
- Inline Headroom-style navigation script.
...
└── assets/
    ├── *.png                # 16 collage plates (Readable Studio instance)
...
- [`readable-landing-deck`](../readable-landing-deck/) — sibling slides skill that reuses this design system.
