...
// allow: SIZE_OK - indivisible template composer for one standalone HTML artifact.
/**
 * readable-landing — HTML composer.
 *
...
function renderRails(i: EditorialCollageInputs): string {
  return `
<div class='side-rail right' data-readable-id='rail-right'>
  <span class='rail-text'>${i.brand.rails.right}</span>
</div>
<div class='side-rail left' data-readable-id='rail-left'>
...
function renderNav(i: EditorialCollageInputs): string {
  const links = i.nav
    ...
    .join('\n          ');
  return `
<header class='nav' data-readable-id='nav'>
...
function renderHero(i: EditorialCollageInputs): string {
  ...
  return `
<section class='hero' id='top' data-readable-id='hero'>
  <div class='container'>
    <div class='sec-rule'>
...
function renderAbout(i: EditorialCollageInputs): string {
  ...
  const assets = i.imagery.assets_path.replace(/\/?$/, '/');
  return `
<section class='about' data-readable-id='about'>
  <div class='container'>
...
function renderCapabilities(i: EditorialCollageInputs): string {
  ...
  const assets = i.imagery.assets_path.replace(/\/?$/, '/');
  return `
<section class='capabilities' id='agents' data-readable-id='capabilities'>
  <div class='container'>
...
function renderLabs(i: EditorialCollageInputs): string {
  ...
  return `
<section class='labs' id='labs' data-readable-id='labs'>
  <div class='container'>
...
function renderMethod(i: EditorialCollageInputs): string {
  ...
  const steps = i.method.steps
    ...
    .join('\n        ');
  return `
<section class='method' data-readable-id='method'>
  <div class='container'>
...
function renderWork(i: EditorialCollageInputs): string {
  ...
  const cards = i.work.cards
    ...
    .join('\n      ');
  return `
<section class='tight' data-readable-id='work'>
  <div class='work'>
    <div class='work-rule'>
      <span class='roman'>${r.roman}</span>
...
function renderTestimonial(i: EditorialCollageInputs): string {
  ...
  const partners = i.testimonial.partners
    ...
    .join('\n        ');
  return `
<section class='testimonial' data-readable-id='testimonial'>
  <div class='container'>
...
function renderCTA(i: EditorialCollageInputs): string {
  const assets = i.imagery.assets_path.replace(/\/?$/, '/');
  return `
<section class='cta' id='contact' data-readable-id='cta'>
  <div class='container'>
...
function renderFooter(i: EditorialCollageInputs): string {
  ...
  const brandCtaHtml = brandCta
    ...
    : '';
  return `
<footer data-readable-id='footer'>
  <div class='container'>
    <div class='foot-grid'>
...
function renderWire(i: EditorialCollageInputs): string {
  ...
  return `
<section class='wire' data-readable-id='wire' aria-label='Global wire — cities and contributors'>
...
/* ------------------------------------------------------------------ *
 * inline interaction scripts
 * ------------------------------------------------------------------ */

const REVEAL_AND_NAV_SCRIPT = `
<script>
  /*
   * Scroll-reveal observer for generated standalone pages.
  ...
  /*
   * Headroom-style sticky header for generated standalone pages.
