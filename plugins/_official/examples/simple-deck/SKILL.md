...
?쒋?? assets/
??  ?붴?? template.html       ??seed: tokens + slide primitives + proven nav script (READ FIRST)
?붴?? references/
    ?쒋?? layouts.md          ??8 paste-ready slide layouts + theme-rhythm rules
    ?붴?? checklist.md        ??P0/P1/P2 self-review (rhythm spot-check at bottom)
```
...
|---|---|
| Product overview / lightning talk (5??0 min) | 6 |
| Pitch deck (15 min) | 8??0 |
| Investor update / longer talk (20??0 min) | 12??8 |
...
- Alternating breath every 3?? slides
