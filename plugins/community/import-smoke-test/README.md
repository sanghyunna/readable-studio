...
A small community plugin for exercising the Readable Studio import UI. It is meant
...
- From GitHub: use `github:sanghyunna/readable-studio@main/plugins/community/import-smoke-test` after the entry is available on `main`.
- Marketplace name: use `community/import-smoke-test` after the community marketplace has been registered or refreshed.

## Expected Result

Readable Studio should install the plugin as a user/community plugin, preserve the
