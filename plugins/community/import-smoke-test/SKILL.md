...
description: A portable community plugin for validating Readable Studio plugin import flows.
---

# Community Import Smoke Test

Use this plugin when validating that Readable Studio can import community plugins
