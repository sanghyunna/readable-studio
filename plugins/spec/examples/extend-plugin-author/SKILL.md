...
description: Use this plugin when the user wants to create, improve, validate, publish, or submit a Readable Studio plugin using the plugin spec, examples, and PR workflow.
license: MIT
metadata:
